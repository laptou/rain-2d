...
namespace Ibinimator.Utility
{
    public static class MathUtils
    {
        ...
        public static (float left, float top, float right, float bottom) Bounds((float left, float top, float right, float bottom) rect, Matrix3x2 m)
        {
        ...
        public static (Vector2, Vector2) CrossSection(Vector2 ray, Vector2 origin, (float Left, float Top, float Right, float Bottom) bounds)
        {
            bounds = (
