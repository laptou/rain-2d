...
namespace Ibinimator.View
{
    public static class Icon
    {
        ...
        {
            AlignBottom =
                new BitmapImage(new Uri("/Ibinimator;component/Resources/Icon/align bottom.png", UriKind.Relative));
            AlignCenterHorizontally =
                new BitmapImage(new Uri("/Ibinimator;component/Resources/Icon/align center horizontally.png",
                    UriKind.Relative));
            AlignCenterVertically =
                new BitmapImage(new Uri("/Ibinimator;component/Resources/Icon/align center vertically.png",
                    UriKind.Relative));
            AlignLeft = new BitmapImage(
                new Uri("/Ibinimator;component/Resources/Icon/align left.png", UriKind.Relative));
            AlignRight =
                new BitmapImage(new Uri("/Ibinimator;component/Resources/Icon/align right.png", UriKind.Relative));
            ...
            CornerBevel =
                new BitmapImage(new Uri("/Ibinimator;component/Resources/Icon/corner-bevel.png", UriKind.Relative));
            CornerMiter =
                new BitmapImage(new Uri("/Ibinimator;component/Resources/Icon/corner-miter.png", UriKind.Relative));
            CornerRound =
                new BitmapImage(new Uri("/Ibinimator;component/Resources/Icon/corner-round.png", UriKind.Relative));
            Cursor = new BitmapImage(new Uri("/Ibinimator;component/Resources/Icon/cursor.png", UriKind.Relative));
            Difference =
                new BitmapImage(new Uri("/Ibinimator;component/Resources/Icon/difference.png", UriKind.Relative));
            ...
            EndSquare = new BitmapImage(
                new Uri("/Ibinimator;component/Resources/Icon/end-square.png", UriKind.Relative));
            Expander = new BitmapImage(new Uri("/Ibinimator;component/Resources/Icon/expander.png", UriKind.Relative));
            Eyedropper =
                new BitmapImage(new Uri("/Ibinimator;component/Resources/Icon/eyedropper.png", UriKind.Relative));
            FlipHorizontally = new BitmapImage(new Uri("/Ibinimator;component/Resources/Icon/flip horizontally.png",
                UriKind.Relative));
            FlipVertically = new BitmapImage(new Uri("/Ibinimator;component/Resources/Icon/flip vertically.png",
                UriKind.Relative));
            ...
            Intersection =
                new BitmapImage(new Uri("/Ibinimator;component/Resources/Icon/intersection.png", UriKind.Relative));
            ...
            ResizeNesw =
                new BitmapImage(new Uri("/Ibinimator;component/Resources/Icon/resize-nesw.png", UriKind.Relative));
            ResizeNs = new BitmapImage(new Uri("/Ibinimator;component/Resources/Icon/resize-ns.png", UriKind.Relative));
            ResizeNwse =
                new BitmapImage(new Uri("/Ibinimator;component/Resources/Icon/resize-nwse.png", UriKind.Relative));
            Restore = new BitmapImage(new Uri("/Ibinimator;component/Resources/Icon/restore.png", UriKind.Relative));
            RotateCcw = new BitmapImage(
                new Uri("/Ibinimator;component/Resources/Icon/rotate ccw.png", UriKind.Relative));
            ...
            StrokeDash =
                new BitmapImage(new Uri("/Ibinimator;component/Resources/Icon/stroke-dash.png", UriKind.Relative));
            StrokeSolid =
                new BitmapImage(new Uri("/Ibinimator;component/Resources/Icon/stroke-solid.png", UriKind.Relative));
