...
namespace Ibinimator.Service.Commands
{
    ...
    {
        public ApplyFormatRangeCommand(long id, ITextLayer target, Format[] newFormat, Format[] oldFormat) : base(id, new[] {target})
        {
        ...
        public override IOperationCommand Merge(IOperationCommand newCommand)
        {
            ...
            var applyFormatRangeCommand = (ApplyFormatRangeCommand) newCommand;

            return new ApplyFormatRangeCommand(Id, Targets[0], applyFormatRangeCommand.NewFormats, OldFormats);
        }
    }
}