...
namespace Ibinimator.Shared.Mathematics
{
    public struct Matrix
    {
        ...
        public float Shear()
        {
            ...
            return MathUtils.Wrap((float)s, MathUtils.TwoPi);
        }
        ...
        {
            return MathUtils.Wrap((float)Math.Atan2(M21, M11), MathUtils.TwoPi);
        }
        ...
        public static Matrix operator * (float them, Matrix me) => me * them;
        ...
        public static Matrix Scale(Vector2 s) => Scale(s.X, s.Y);

        public static Matrix Scale(float s) => Scale(s, s);

        public static Matrix Scale(float x, float y, float cx, float cy) =>
            Translate(-cx, -cy) * Scale(x, y) * Translate(cx, cy);

        public static Matrix Scale(float x, float y, Vector2 c) => Scale(x, y, c.X, c.Y);

        public static Matrix Scale(Vector2 s, Vector2 c) => Scale(s.X, s.Y, c.X, c.Y);
        ...
        public static Matrix Shear(float x, float y, float cx, float cy) =>
            Translate(-cx, -cy) * Shear(x, y) * Translate(cx, cy);

        public static Matrix Shear(float x, float y, Vector2 c) => Shear(x, y, c.X, c.Y);

        public static Matrix Shear(Vector2 s, Vector2 c) => Shear(s.X, s.Y, c.X, c.Y);
        ...
        public static Matrix Translate(Vector2 t) => Translate(t.X, t.Y);

        public static Matrix Translate(float t) => Translate(t, t);
        ...
        public static Matrix Rotate(float a, Vector2 c) => Rotate(a, c.X, c.Y);
    }
}
