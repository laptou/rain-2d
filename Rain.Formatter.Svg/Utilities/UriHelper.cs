...
namespace Rain.Formatter.Svg.Utilities
{
    ...
    {
        public static Uri FromId(string id) { return new Uri("#" + id, UriKind.Relative); }
        ...
        {
            return Uri.TryCreate(str, UriKind.Relative, out uri) || Uri.TryCreate(str, UriKind.Absolute, out uri);
        }
    }
}