...
namespace Rain.Native
{
    ...
    internal static class WindowHelper
    {
        ...
        public static extern IntPtr CreateWindowEx(
            WindowStylesEx dwExStyle, ushort lpszClassName, string lpszWindowName, WindowStyles style, int x, int y,
            int width, int height, IntPtr hWndParent, IntPtr hMenu, IntPtr hInst, [MarshalAs(AsAny)] object pvParam);
        ...
        [DllImport("user32.dll")]
        public static extern bool InvalidateRect([In] IntPtr hWnd, [In] ref NativeRect lpRect, [In] bool bErase);
