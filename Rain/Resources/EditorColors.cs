...
namespace Rain.Resources
{
    internal static class EditorColors
    {
        ...
        public static readonly Color
            SelectionReferenceOutline = new Color(0.565f, 0.816f, 0.988f); // #90d0fc

        public static readonly Color SelectionHandle = new Color(1f); // #FFFFFF

        public static readonly Color
            SelectionHandleOutline = new Color(0.345f, 0.831f, 0.196f); // #58D432

        public static readonly Color
            GradientHandleSelected = new Color(0.565f, 0.816f, 0.988f); // #90d0fc

        public static readonly Color Node           = new Color(1f); // #FFFFFF
        public static readonly Color SpecialNode    = new Color(0.9f, 1f, 0.9f, 0.75f);
        ...
        public static readonly Color
            SpecialNodeOutline = new Color(0.565f, 0.816f, 0.988f); // #90d0fc

        public static readonly Color Guide = new Color(0.357f, 0.753f, 0.922f); // #5BC0EB

        public static readonly Color
            TextHighlight = new Color(0.345f, 0.831f, 0.196f, 0.5f); // #58D432 
